...
def get_test_ride_by_username(
    username: str, _auth: dict = Depends(has_any_role(["ROLE_ADMIN", "ROLE_USER"]))
):
...
def get_test_ride_by_location(
    location: str, _auth: dict = Depends(has_any_role(["ROLE_ADMIN"]))
):
